...
export const bulbasaurFormatted = {
  name: 'bulbasaur',
  id: 1,
  sprites: {
    back_default:
...
export const pokemonBatch = {
  "count": 1302,
  "next": "https://pokeapi.co/api/v2/pokemon/?offset=26&limit=25",
...
export const pokemonBatchFormatted = [
  {
      "name": "bulbasaur",
      "id": 1
  },
